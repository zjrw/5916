...
define('models/settings-model',["require", "exports", "./player-settings-model", "./cpu-settings-model"], function (require, exports, player_settings_model_1, cpu_settings_model_1) {
    ...
    var SettingsModel = (function () {
        ...
        SettingsModel.prototype.updateSchedule = function (useSchedule) {
            if (useSchedule) {
                this.schedule = this.schedule || new Map();
                this.scheduleText = "";
            }
            else {
...
define('pages/Home/home',["require", "exports", "aurelia-templating-resources", "aurelia-framework", "models/settings-model", "models/cpu-settings-model", "clipboard", "../Setting-Service"], function (require, exports, aurelia_templating_resources_1, aurelia_framework_1, settings_model_1, cpu_settings_model_1, clipboard_1, Setting_Service_1) {
    ...
    var HomeViewModel = (function () {
        function HomeViewModel(signaler, settingsService) {
            ...
            this.playerSchedules = new Array(this.numberOfPlayers).fill('');
        ...
        HomeViewModel.prototype.updateUrl = function () {
            var iframe = document.getElementById('gamePreview');
            iframe.src = this.url;
            this.settings.updateSchedule(this.settings.useSchedule);
        };
        ...
        HomeViewModel.prototype.initializeSchedules = function () {
            if (this.settings.scheduleArray) {
                this.playerSchedules = this.settings.scheduleArray.split('\n');
                this.numberOfPlayers = this.playerSchedules.length;
            }
            else {
                this.playerSchedules = new Array(this.numberOfPlayers).fill('');
            }
        };
        Object.defineProperty(HomeViewModel.prototype, "computedScheduleArray", {
            get: function () {
                return this.playerSchedules
                    .filter(function (schedule) { return schedule.trim() !== ''; })
                    .join('\n');
            },
            enumerable: false,
            configurable: true
        });
        HomeViewModel.prototype.playerScheduleChanged = function (index, newValue) {
            var playerIndex = index + 2;
            var prefixedSchedule = "".concat(playerIndex, ",").concat(newValue.replace(/(^,)|(,$)/g, ''));
            this.playerSchedules[index] = prefixedSchedule;
            this.settings.scheduleText = this.computedScheduleArray;
        };
        __decorate([
        ...
        __decorate([
            (0, aurelia_framework_1.computedFrom)('playerSchedules'),
            __metadata("design:type", String),
            __metadata("design:paramtypes", [])
        ], HomeViewModel.prototype, "computedScheduleArray", null);
